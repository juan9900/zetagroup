...
const language = {
    eng: {
        ...
        section2Project5Title: 'Bathroom',
        section2Project5Content: 'ENG KITCHEN Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laccusantium doloremque laudan ',
    ...
    es: {
        ...
        section2Project5Title: 'Baño',
        section2Project5Content: 'ESPA COCINA Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laccusantium doloremque laudan ',
...
if (window.location.hash) {
    ...
    if (window.location.hash == "#es") {
        ...
        $('#btn-projects-1').text(language.es.section2Project1Title);
        $('#btn-projects-2').text(language.es.section2Project2Title);
        $('#btn-projects-3').text(language.es.section2Project3Title);
        $('#btn-projects-4').text(language.es.section2Project4Title);
        $('#btn-projects-5').text(language.es.section2Project5Title);
        ...
        $('.project-5-title').text(language.es.section2Project5Title);
        $('.project-5-content').text(language.es.section2Project5Content);
        ...
        $('#btn-projects-1').text(language.eng.section2Project1Title);
        $('#btn-projects-2').text(language.eng.section2Project2Title);
        $('#btn-projects-3').text(language.eng.section2Project3Title);
        $('#btn-projects-4').text(language.eng.section2Project4Title);
        $('#btn-projects-5').text(language.eng.section2Project5Title);
        ...
        $('.project-5-title').text(language.eng.section2Project5Title);
        $('.project-5-content').text(language.eng.section2Project5Content);
